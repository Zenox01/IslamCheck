...
class PlayerContextProvider_PlayerContextProvider extends external_root_React_commonjs_react_commonjs2_react_amd_react_["Component"] {
  ...
  reloadActiveTrack(_temp) {
    let _ref2 = _temp === void 0 ? {} : _temp,
        _ref2$shouldPlay = _ref2.shouldPlay,
        shouldPlay = _ref2$shouldPlay === void 0 ? false : _ref2$shouldPlay;
  ...
  handleTrackPlaybackFailure(event) {
    ...
    const error = event.target.error; // If there's a network error, the current track should be reloaded
  ...
  registerVideoHostElement(hostElement, _ref3) {
    let onHostOccupied = _ref3.onHostOccupied,
